...
- We learned to plan and execute UAT sessions with the customer, which helped us validate the system early.
...
- Quality requirements and tests are useful and can be automated in CI.

## Problems we faced
- No hardware for testing (real flight controller, UWB anchors).
- We had no tests before — we started from zero and built them during this Sprint.
