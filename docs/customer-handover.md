...
1. Start SITL and backend.
2. Open QGroundControl – you should see a connected vehicle.
3. Upload a mission via Swagger UI or QGroundControl.
4. Switch to Auto mode – the vehicle should move.
